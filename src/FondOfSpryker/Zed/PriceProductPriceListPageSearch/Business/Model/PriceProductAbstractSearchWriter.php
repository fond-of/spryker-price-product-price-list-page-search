...
{
    /**
     * @var \FondOfSpryker\Zed\PriceProductPriceListPageSearch\Dependency\Plugin\PriceProductAbstractPriceListPageDataExpanderPluginInterface[]
     */
     ...
     * @param \FondOfSpryker\Zed\PriceProductPriceListPageSearch\Dependency\Plugin\PriceProductAbstractPriceListPageDataExpanderPluginInterface[] $priceProductAbstractPriceListPageDataExpanderPlugins
     */
    ...
    protected function expandPriceProductPriceListPageSearchTransfer(
        ...
        foreach ($this->priceProductAbstractPriceListPageDataExpanderPlugins as $expanderPlugin) {
