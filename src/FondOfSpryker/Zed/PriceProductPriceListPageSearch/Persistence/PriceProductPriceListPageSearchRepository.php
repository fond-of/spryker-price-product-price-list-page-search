...
class PriceProductPriceListPageSearchRepository extends AbstractRepository implements PriceProductPriceListPageSearchRepositoryInterface
{
     ...
     */
    protected function queryPriceProductPriceList(): FosPriceProductPriceListQuery
    {
        return $this->getFactory()
    ...
    protected function withPriceProductAbstractData(ModelCriteria $modelCriteria): ModelCriteria
    {
        return $this->withPriceProductData($modelCriteria)
            ...
            ->withColumn(FosPriceProductPriceListTableMap::COL_FK_PRODUCT_ABSTRACT, PriceProductPriceListPageSearchTransfer::ID_PRODUCT);
    }
    ...
    protected function withPriceProductConcreteData(ModelCriteria $modelCriteria): ModelCriteria
    {
        return $this->withPriceProductData($modelCriteria)
            ...
            ->withColumn(FosPriceProductPriceListTableMap::COL_FK_PRODUCT, PriceProductPriceListPageSearchTransfer::ID_PRODUCT);
    }
    ...
    protected function withPriceProductData(ModelCriteria $modelCriteria): ModelCriteria
    {
        return $modelCriteria
            ...
            ->withColumn(FosPriceProductPriceListTableMap::COL_FK_PRICE_LIST, PriceProductPriceListPageSearchTransfer::ID_PRICE_LIST)
            ->withColumn(FosPriceListTableMap::COL_NAME, PriceProductPriceListPageSearchTransfer::PRICE_LIST_NAME)
